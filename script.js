...
const sr = ScrollReveal({
  ...
  sr.reveal('#shop', { delay: 200, origin: 'bottom' }); 
  sr.reveal('#review', { delay: 250, origin: 'bottom' }); 
  sr.reveal('#blog',{ delay: 500, origin: 'right' });
  sr.reveal('#contact',{delay:350,origin:'left'});
  sr.reveal('.mainText',{delay:400, origin:'top'});
  sr.reveal('.img',{delay:450, origin:'right'});
  sr.reveal('#shop',{delay:550, origin:'bottom'});
